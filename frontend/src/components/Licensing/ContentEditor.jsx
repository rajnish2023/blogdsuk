...
const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "extensionsKicker", label: "Extensions list heading" },
      { key: "extensionsNote", label: "Extensions note", long: true, hint: "{tier} is replaced with the licence tier" },
      { key: "coreOnlyPrefix", label: "Footnote prefix when extensions apply" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "extensionsSuffix", label: "Extension count suffix" },
